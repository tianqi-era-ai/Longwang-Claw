...
const uat_client_1 = require("./uat-client");
const token_store_1 = require("./token-store");
const app_scope_checker_1 = require("./app-scope-checker");
const app_owner_fallback_1 = require("./app-owner-fallback");
const lark_logger_1 = require("./lark-logger");
const scope_manager_1 = require("./scope-manager");
const raw_request_1 = require("./raw-request");
const owner_policy_1 = require("./owner-policy");
...
function createToolClient(config, accountIndex = 0) {
    ...
    let account;
    if (ticket?.accountId) {
        const resolved = (0, accounts_1.getLarkAccount)(config, ticket.accountId);
